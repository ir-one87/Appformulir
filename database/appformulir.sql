...
CREATE TABLE IF NOT EXISTS `formulirs` (
  ...
  `sk` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '0',
  `status_berkas` tinyint(1) NOT NULL DEFAULT '0',
  `status_tte` tinyint(1) NOT NULL DEFAULT '0',
  `pesan` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `formulirs_instansi_id_foreign` (`instansi_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(5, '2023_12_29_144338_create_formulirs_table', 1),
(6, '2024_01_01_070053_create_organisasis_table', 1),
(7, '2024_01_01_071358_create_berkas_table', 1),
(8, '2024_01_14_064022_create_rekaps_table', 1);
...
CREATE TABLE IF NOT EXISTS `rekaps` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
