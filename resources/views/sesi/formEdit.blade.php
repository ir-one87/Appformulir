        ...
        <div class="col-12">
            <div class="card h-100">
                <div class="card-header">
                    <div class="card-title">Edit Akun OPD</div>
                </div>

                <div class="card-body">
                    <form action="{{ route('update', $akuns) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                        <div class="row gutters">
